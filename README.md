# Python sensor-cloud.io Client Library
...
```sh
pip install git+https://github.com/jcu-eresearch/pySensorCloud.git
```
(you may need to run `pip` with root permission: `sudo pip install git+https://github.com/jcu-eresearch/pySensorCloud.git`)
